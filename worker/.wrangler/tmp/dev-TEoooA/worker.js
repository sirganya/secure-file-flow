...
// .wrangler/tmp/bundle-Vc2VVb/checked-fetch.js
...
var TICKET_STORE = /* @__PURE__ */ new Map();
...
var mintTicket = /* @__PURE__ */ __name(async (c) => {
...
var claimTicket = /* @__PURE__ */ __name(async (c) => {
  const body = await c.req.json();
